 ...
 */
public class SuggestionDateDialogue extends SequentialDialogue {

    public SuggestionDateDialogue(Context context, LayoutInflater inflater, SequentialDialogue nextInSequence) {
