...
/**
 * A basic sample which shows how to use {@link com.mapster.view.SlidingTabLayout}
...
public class SlidingTabsBasicFragment extends Fragment {
    ...
    class SamplePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            View view = null;
            if (position == 0) {
                view = getActivity().getLayoutInflater().inflate(R.layout.budget_fragment,
                        container, false);
            } else {
                view = getActivity().getLayoutInflater().inflate(R.layout.schedule_fragment,
                        container, false);
            }
